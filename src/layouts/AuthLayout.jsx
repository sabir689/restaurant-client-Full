...
const AuthLayOut = () => {
    return (
       ...
       <div>
        ...
        >
            {/* Main Card Container */}
            <div className="bg-amber-100 mt-40 backdrop-blur-sm shadow-2xl flex flex-col md:flex-row w-full max-w-5xl mx-4 overflow-hidden rounded-lg border border-gray-200 mb-20 ">
